...
READING (list_bugs, get_bug): these are read-only - they never change anything in the tracker. Use list_bugs to find which bug(s) a developer means (e.g. "what's open in the mobile app right now"), then get_bug with the bug's number for full detail, including its screenshots, before diagnosing or proposing a fix.
